...
public class Parchase_replacement extends javax.swing.JInternalFrame {
    ...
    /**
     * Creates new form purchase_replacement
     */
    public Parchase_replacement() {
        initComponents();
        getPurchaseReplacement();
    }
public void getPurchaseReplacement() {
        Connection conn;
        ...
        try {
            ...
            String query = "select * from SM_PURCHASE_REPLACEMENT";
    ...
    private void jButton2ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton2ActionPerformed
        ...
        try {
            ...
            String query = "insert into SM_PURCHASE_REPLACEMENT values(1,'" + date + "','" + code + "','"
